...
export function CommandMenu({ focusRing }: CommandMenuProps) {
  ...
  return (
    <div className="fixed inset-0 z-[70] grid place-items-start bg-pitch-black/30 bg-opacity-35 px-4 py-20 backdrop-blur-[2px]" role="dialog" aria-modal="true" aria-label="Command menu">
